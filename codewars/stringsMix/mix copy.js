const mix = (s1, s2) => {
    ...
    const sortObjectByValue = ((a,b) => {
        ...
        return a[aK][0].length < b[bK][0].length ? 1 : -1
        //return a[aK].length%2 === 0 && a[aK].length%2 === 1 ? -1 : 1;
    });
    ...
    Array.prototype.sortNumericKey = function() {
        return this.filter(e => Object.keys(e)[0] !== "=").concat(this.filter(e => Object.keys(e)[0] === "="));
    }
    ...
    Array.prototype.filterSort = function() {
        ...
        const sizes2 = [...new Set(arr.map(e => {
            return {[Object.keys(e)[0]]:{[Object.values(e)[0][0]]: Object.values(e)[0].length}};
        }))];
        console.log(sizes2);
        const keys = [...new Set(arr.map(e => Object.keys(e)[0]).join(""))];
        const orderKeys = keys.includes("=") ? keys.concat(keys.splice(keys.indexOf("="),1)) : keys;
        const orderedArray = [];
